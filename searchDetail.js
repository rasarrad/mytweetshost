...
*/
    ...
    if (val.type == "T") {
        ...
        twttr.widgets.createTweet(
          ...
          .then (function (el) {
            //if (val.info.trim() != "")
                $("#tw" + val.id).append($('<textarea id="tweetinfo' + val.id + '" rows="104" class="textinfo" spellcheck="false" autocomplete="none" additionalattributes="{autocomplete: \'none\'}"></textarea><i onclick="javascript: expandInfo(this)" class="clicable fa fa-chevron-circle-down buttontweet"></i><i cid="' + val.id + '" onclick="javascript: copyInfo(this)" class="clicable fa fa-clone buttontweet"></i><i cid="' + val.id + '" cinfo="' + val.info + '" onclick="javascript: copyInfoAll(this)" class="clicable fa fa-clone buttontweet copy2"></i><i onclick="javascript: expandTweet(this)" class="clicable fa fa-chevron-circle-down buttontweet topps"></i><i cinfo="' + val.info + '" onclick="javascript: saveInfo(this)" class="clicable fa fa-save buttontweet"></i>'));
