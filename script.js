    ...
    var togglecriterions = function() 
    {
      if ($('.toptitle').css('display') == 'none') {
        ...
        setTimeout(function(){
          ...
          $('.toptitle').css('opacity', '1').effect( "pulsate", {}, 500 );
        }, 400);
      }
      else {
        $(".toptitle").css("transition", "opacity 0.7s");
        ...
        setTimeout(function(){
          ...
          $(".top").css("transition", "opacity 0.7s");
          $('.top').css('opacity', '1').effect( "pulsate", {}, 500 );
        }, 400);
      } 
    }   
